...
<body class="hold-transition skin-blue layout-top-nav">
	<div class="wrapper">
     ...
     ?>
					<h1 class="page-header text-center title title-custom"><b><?php echo strtoupper(
         $title
     ); ?></b></h1>
					<div class="row">
       ...
       if ($vquery->num_rows > 0) { ?>
        ...
        while ($row = $query->fetch_assoc()) {
            $sql =
                "SELECT candidates.*, partylists.name AS partylist_name 
            FROM candidates 
            ...
            <li>
                ' .
                    $input .
                    '
                <button type="button" class="btn btn-primary btn-sm btn-flat clist platform" data-platform="' .
                    $crow["platform"] .
                    '" data-fullname="' .
                    $crow["firstname"] .
                    " " .
                ...
                <a href="' .
                    ...
                    '">
                    	<img src="' .
                    $image .
                    '" height="100px" width="100px" class="clist">
                </a>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-solid box-custom" id="' .
                $row["id"] .
                '">
                ...
                '
                            <span class="pull-right">
                                <button type="button" class="btn btn-success btn-sm btn-flat reset" data-desc="' .
                slugify($row["description"]) .
    ...
    ';
        ...
        ?>
								...
								<div class="text-center">
									...
									<button type="submit" class="btn btn-primary btn-flat custom-button" name="vote"><i
