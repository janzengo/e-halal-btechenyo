        ...
        return (
          <>
            <li
              data-component="stepper-step"
              className={cn([
                "group peer relative flex items-center gap-1 sm:gap-2 flex-shrink-0",
      ...
      Controls: ({ children, className, asChild, ...props }) => {
        ...
        return (
          <Comp
            ...
            className={cn("flex flex-col sm:flex-row justify-end gap-3 sm:gap-4", className)}
            {...props}
          >
            {children}
          </Comp>
...
const Title = ({
  ...
  return (
    <Comp
      ...
      className={cn("text-xs sm:text-sm font-medium whitespace-nowrap", className)}
      {...props}
    >
      {children}
    </Comp>
...
const classForNavigationList = cva("flex gap-1 sm:gap-2", {
  variants: {
    variant: {
      horizontal: "flex-row items-center justify-start sm:justify-between overflow-x-auto pb-2 px-1 sm:px-0",
      vertical: "flex-col",
      circle: "flex-row items-center justify-start sm:justify-between overflow-x-auto pb-2 px-1 sm:px-0",
    },
  },
});
